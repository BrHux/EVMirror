...
public final class ViewfinderView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        Log.d(TAG, "init: frameWidth:"+frameWidth);
        Log.d(TAG, "init: frameHeight:"+frameHeight);
        ...
        if(frameWidth<=0 || frameWidth > screenWidth){
            frameWidth = size;
            Log.d(TAG, "frameWidth init: "+frameWidth);
        }

        if(frameHeight<=0 || frameHeight > screenHeight){
            frameHeight = size;
            Log.d(TAG, "frameHeight init: "+frameHeight);
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.d(TAG, "onMeasure: leftOffset"+leftOffset);
        Log.d(TAG, "onMeasure: topOffset"+topOffset);
